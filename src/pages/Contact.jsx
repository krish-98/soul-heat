    ...
    <div className="bg-[#f5f3f3] min-h-screen p-6 lg:px-10 lg:pt-8">
      <div className="max-w-[960px] mx-auto">
        ...
        <div className="space-y-2 pb-4">
          ...
          <p className="indent-6 tracking-wide">
            While "Soul Heat" primarily operates online, you can find our office
            at:
            <br />
        ...
        <div className="space-y-2 pb-4">
          ...
          <p className="indent-6 tracking-wide">
            ...
            following hours:
            <br />
            Monday to Friday: 9:00 AM - 6:00 PM (EST) Saturday and Sunday: 10:00
            AM - 4:00 PM (EST)
          </p>
        </div>
        ...
        <div className="space-y-2 pb-4">
          ...
          <p className="indent-6 tracking-wide">
            Before reaching out to us, you might find answers to your questions
            in our FAQ section. It's a helpful resource for common inquiries.
          </p>
        </div>
        ...
        <div className="space-y-2 pb-4">
          ...
          <p className="indent-6 tracking-wide">
            ...
            <br />
            Thank you for choosing "Soul Heat." We look forward to hearing from
            you and serving you with the best in culinary experiences. Your
            satisfaction is our priority, and we're here to make your "Soul
            Heat" experience exceptional.
          </p>
        </div>
